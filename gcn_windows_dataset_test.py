...
class TimeWindowsDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        # print("self._data_filepaths: ",self._data_filepaths," self._label_filepath:  ",self._label_filepath)

        # define indexes for the current partition
        self._partition_indexes = self._set_indexes_partition()
        # self._partition_indexes = [0]
        # print("self._partition_indexes: ",self._partition_indexes)

        self._partition_filepaths = self._data_filepaths[self._partition_indexes]
        # read partition data, filepaths or data directly
        # print("self._partition_filepaths: ",self._partition_filepaths)
        ...
        if self.pin_memory:
            ...
            # print("self.partition_data: ",self.partition_data)
